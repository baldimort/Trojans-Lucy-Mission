...
#
def main(indate,inparams,epoch_osc,epoch):
	from ephem import *
	...
	minor._M = inparams[0]
	minor._om = inparams[1]
	minor._Om = inparams[2]
	minor._inc = inparams[3]
	minor._e = inparams[4]
	minor._a = inparams[5]
	

	#elements = open(inelements)
	...
	minor._epoch_M = epoch_osc #set to '2018/02/15'
	minor._epoch = epoch #set to '2455720.5'
	...
	#print " "
	return (x_sun-x_minor, y_sun-y_minor, z_sun-z_minor)
